# Agent setup for `sycom-learn`

This is a deepsec scanning workspace. Project `sycom-learn` was just registered
(target: `..`). Setup is incomplete — `data/sycom-learn/INFO.md`
...
2. **Fill in `data/sycom-learn/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id sycom-learn
pnpm deepsec process --project-id sycom-learn
```
