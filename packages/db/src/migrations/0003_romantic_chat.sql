...
CREATE TABLE "member" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "member_userId_organizationId_unique" UNIQUE("user_id","organization_id")
);
--> statement-breakpoint
...
CREATE TABLE "team_member" (
	...
	"user_id" text NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "teamMember_teamId_userId_unique" UNIQUE("team_id","user_id")
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "profile_userId_unique" ON "profile" USING btree ("user_id");