  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        className="absolute -inset-px flex items-center justify-center text-primary-foreground data-indeterminate:text-foreground data-checked:bg-primary data-unchecked:hidden"
