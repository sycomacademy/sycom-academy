...
import { PanelLeftCloseIcon } from "@sycom-learn/ui/components/animated/icons/panel-left-close";
...
import {
  ...
  SheetPopup,
  SheetTitle,
} from "@sycom-learn/ui/components/sheet";
import { Skeleton } from "@sycom-learn/ui/components/skeleton";
import { Tooltip, TooltipPopup, TooltipTrigger } from "@sycom-learn/ui/components/tooltip";
import { AnimateIcon } from "@sycom-learn/ui/components/animated/icons/icon";
import { PanelLeftOpenIcon } from "@sycom-learn/ui/components/animated/icons/panel-left-open";
import { MenuIcon } from "lucide-react";

export const SIDEBAR_COOKIE_NAME: string = "sidebar_state";
...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-240 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-240 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none md:flex",
          side === "left"
...
export function SidebarGroupLabel({
  ...
  const defaultProps = {
    className: cn(
      "flex h-8 shrink-0 items-center rounded-lg px-2 text-xs font-medium text-sidebar-foreground ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-240 ease-[cubic-bezier(0.32,0.72,0,1)] focus-visible:ring-2 motion-reduce:transition-none [&>svg]:size-4 [&>svg]:shrink-0",
